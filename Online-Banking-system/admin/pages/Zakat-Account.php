    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                         ...
                         <div class="container">
                <h3 style="text-align:center;">Detection of Zakat</h3>
                  <form action="Zakat-Accountdp.php" method="post">
                    <input type="text" id="fname" name="Min" placeholder="Minimum Amount">
                    <input type="text" id="lname" name="per" placeholder="Percentage">
                    <br>
