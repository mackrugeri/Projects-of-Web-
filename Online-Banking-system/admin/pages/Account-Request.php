  ...
  <!-- ============================================================== -->
    ...
    <div class="dashboard-main-wrapper">
            ...
            <div class="container-fluid dashboard-content">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h3 class="text-center">Account Requests</h3>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
             ...
             <div class="container">
                <h3 style="text-align:center;">Approval of Account</h3>
                  <form action="/action_page.php">
                    <input type="text" id="fname" name="firstname" placeholder="Account Number">
                    <input type="text" id="lname" name="lastname" placeholder="customer-Id">
                    <br>
             ...
             <div class="container">
                <h3 style="text-align:center;">Rejection of Account</h3>
                  <form action="/action_page.php">
                    <input type="text" id="fname" name="firstname" placeholder="customer-Id">
                    <br>
